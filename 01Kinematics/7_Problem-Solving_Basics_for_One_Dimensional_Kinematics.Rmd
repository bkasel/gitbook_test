...
(credit: scui3asteveo,
Flickr)](images/Figure_02_06_00.jpg){#import-auto-id1788945}

::: {#fs-id2494789 .learning-objectives depth="1"}
...
::: {#fs-id952201 depth="1"}
### Problem-Solving Steps {#problem-solving-steps data-type="title"}
...
::: {#fs-id2092387 depth="2"}
#### Step 1 {#step-1 data-type="title"}

*Examine the situation to determine which physical principles are
involved*. It often helps to *draw a simple sketch* at the outset. You
...
::: {#fs-id2204794 depth="2"}
#### Step 2 {#step-2 data-type="title"}
...
::: {#fs-id1754393 depth="2"}
#### Step 3 {#step-3 data-type="title"}
...
::: {#fs-id1770068 depth="2"}
#### Step 5 {#step-5 data-type="title"}
...
::: {#fs-id1372026 depth="2"}
#### Step 6 {#step-6 data-type="title"}

*Check the answer to see if it is reasonable: Does it make sense?* This
...
::: {#fs-id2176647 depth="1"}
### Unreasonable Results {#unreasonable-results data-type="title"}
...
::: {#fs-id1987367 depth="2"}
#### Step 1 {#step-1-1 data-type="title"}

*Solve the problem using strategies as outlined and in the format
...
::: {#import-auto-id4167672 data-type="equation"}
$${{{{v = {v_{0} + \text{at}}} = {0 + \left( {0\text{.}\text{40}\ \text{m/s}^{2}} \right)}}{\left( {\text{100}\ \text{s}} \right) = \text{40}}\ \text{m/s}}.}{}$$
:::
:::

::: {#fs-id2525779 depth="2"}
#### Step 2 {#step-2-1 data-type="title"}

*Check to see if the answer is reasonable*. Is it too large or too
small, or does it have the wrong sign, improper units, ...? In this
case, you may need to convert meters per second into a more familiar
unit, such as miles per hour.

::: {#import-auto-id1437508 data-type="equation"}
...
::: {#fs-id4130945 depth="2"}
#### Step 3 {#step-3-1 data-type="title"}

*If the answer is unreasonable, look for what specifically could cause
...
::: {#fs-id1602384-summary depth="1"}
### Section Summary { data-type="title"}

-   [*The six basic problem solving steps for physics
    are:*]{#import-auto-id927917}

    *Step 1*. Examine the situation to determine which physical
    principles are involved.

    *Step 2*. Make a list of what is given or can be inferred from the
    problem as stated (identify the knowns).

    *Step 3*. Identify exactly what needs to be determined in the
    problem (identify the unknowns).

    *Step 4*. Find an equation or set of equations that can help you
    solve the problem.
    ...
    *Step 6*. Check the answer to see if it is reasonable: Does it make
    sense?
:::

::: {#fs-id2577484 .conceptual-questions depth="1" element-type="conceptual-questions"}
### Conceptual Questions { data-type="title"}

::: {#fs-id4087579 data-type="exercise" element-type="conceptual-questions"}
::: {#fs-id4067228 data-type="problem"}
What information do you need in order to choose which equation or
equations to use to solve a problem? Explain.
:::
:::

::: {#fs-id1986766 data-type="exercise" element-type="conceptual-questions"}
::: {#fs-id2013359 data-type="problem"}
